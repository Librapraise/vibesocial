...
import EventGallery from './pages/discover/EventGallery';
import EventOrders from './pages/organizer/EventOrders';
import Feedback from './pages/public/Feedback';
import HelpCenter from './pages/public/HelpCenter';
import Leaderboard from './pages/discover/Leaderboard';
import MyCalendar from './pages/discover/MyCalendar';
import MyHostedEvents from './pages/organizer/MyHostedEvents';
